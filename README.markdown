...
Build stable Rust binaries for Xous! This release targets Rust 1.85.0.

## Installing Prebuilt Releases

1. Ensure you are running Rust 1.85.0. Future versions of Rust will need a different version of this software.
...
wget https://github.com/betrusted-io/rust/releases/latest/download/riscv32imac-unknown-xous_1.85.0.zip
...
Invoke-WebRequest -Uri https://github.com/betrusted-io/rust/releases/latest/download/riscv32imac-unknown-xous_1.85.0.zip -Outfile toolchain.zip
